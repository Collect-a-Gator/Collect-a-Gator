...
export default function EditPage() : React.ReactNode {
    ...
    useEffect(() => {
        const call = async () => await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/entries/${entryId}`)
    ...
    const updateData = async () => {
        const fetchData = async () => {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/entries/${entryId}`, {
                method: "PUT",
                body: JSON.stringify({
                    title: title,
                    date: date,
